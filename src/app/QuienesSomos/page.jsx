...
export default function page () {
  return (
    <>
      <section className='w-full max-sm:py-24 max-sm:p-0 p-28 min-[2560px]:p-36 h-auto flex items-center justify-center'>
      ...
      <section className='p-5'>
        <div className='w-full h-auto min-[1920px]:h-[35vh] min-[2560px]:h-[40vh] flex rounded-md py-2 border-blue-200 border-[4px] bg-blue-200 shadow-md'>
          <div className='w-full h-full flex flex-col items-center justify-center p-10'>
            <h1 className='text-white font-mono font-bold text-2xl my-3 min-[1920px]:text-3xl min-[2560px]:text-5xl'>QUIENES SOMOS</h1>
            <p className='text-lg font-normal max-w-[70%] text-center min-[1920px]:text-2xl min-[2560px]:text-3xl'>Max-Autos es una empresa llanera con una trayectoria De más de 10 años en el sector automotriz
              que ha logrado posicionarse como marca líder en la ciudad de Villavicencio, trabajando siempre
              para satisfacer las necesidades de nuestros clientes y superar sus expectativas, haciendo cada
              vez más clientes felices.
            </p>
