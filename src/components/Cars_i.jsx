      ...
      <div className='h-full grid 2xl:grid-cols-4 xl:grid-cols-3 grid-cols-1 gap-6 p-5'>
        {result.map((car) => (
          <div key={car.id} className='max-w-sm h-[500px] m-auto mt-0 flex flex-col overflow-hidden border-2 border-blue-400 rounded-md'>
            <div className='w-full h-[284px] bg-white p-4 overflow-hidden border-2 rounded'>
              <img className='object-cover w-full h-full outline-2 outline outline-blue-400' src={car.image} alt='' />
            </div>
            <div className='w-full h-[62px] flex items-center justify-center bg-white p-3'>
