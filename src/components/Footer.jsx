    ...
    <>
      <footer className='grid grid-cols-1 md:grid-cols-3 h-auto bg-blue-400 p-6'>
        <div className='flex flex-col items-center justify-center'>
          <img className='w-28 h-20 my-4' src={MaxIcon.src} />
          <h1 className='text-lg italic'>Usados que dan confianza</h1>
        </div>
        <hr className='my-2 md:hidden' />
        <div className='flex flex-col items-center justify-center'>
          <h1 className='my-2 font-semibold'>CONTACTANOS</h1>
          <Link href='mailto:maxautosmb53@gmail.com' className='flex my-2'><HiOutlineMail className='mx-1' size={25} />maxautosmb53@gmail.com</Link>
          <Link href='https://wa.me/573123719021' target='_blank' className='flex my-2' rel='noreferrer'><BsWhatsapp className='mx-1' size={25} />+57 312 3719021</Link>
          <Link href='https://www.instagram.com/maxautosusados/' target='_blank' className='flex my-2' rel='noreferrer'><AiOutlineInstagram className='mx-1' size={25} />maxautosusados</Link>
        </div>
        <hr className='my-2 md:hidden' />
        <div className='flex flex-col items-center justify-center'>
