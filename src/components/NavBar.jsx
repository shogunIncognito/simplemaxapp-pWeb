...
export default function NavBar () {
  return (
    <header className=' bg-transparent shadow-xl flex-col md:flex-row top-0 absolute duration-300 ease-in-out transition-all z-50 p-4 flex w-full items-center'>
      <Link href='/' className='md:absolute'>
        <MaxAutosIcon />
      </Link>
      <nav className='m-auto w-full flex justify-center items-center'>
        <ul className='flex justify-center items-center'>
          <li className='hover:scale-110 text-white'>
